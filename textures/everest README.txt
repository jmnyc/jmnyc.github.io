...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=everest&box=86.987097,28.000288,86.905704,27.928423
...
-----------
  ...
  * everest Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * everest Height Map (SRTM3 v4.1).png
  ...
  * everest Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 5138m (actual) is equal to 40m in
